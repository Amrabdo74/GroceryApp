...
const [toggled, setToggled] = useState(false);
  ...
  return(
        ...
        <button className="button-toogle " onClick={()=>setToggled(!toggled)}>{toggled ? 'Hide Filter-Items <':'Show Filter-Items  >' }</button>
          ...
          <Sidebar style={{left: toggled ? '0' : "-300px"}} >
            <Menu>
              ...
              >
                ...
                <MenuItem
                  onClick={() =>
                    dispatch(filtersubcategorys("leaf vegetables"))
                  }
                >
                  Leaf Vegetables
                </MenuItem>
                <MenuItem
                  onClick={() =>
                    dispatch(filtersubcategorys("stem vegetables"))
                  }
                >
                  {" "}
                  Stem Vegetables
                ...
                <MenuItem
                  onClick={() =>
                    dispatch(filtersubcategorys("root vegetables"))
                  }
                >
                  {" "}
                  Root Vegetables
                ...
                <MenuItem
                  onClick={() =>
                    dispatch(filtersubcategorys("seed vegetables"))
                  }
                >
                  {" "}
                  Seed Vegetables
              ...
              >
                <MenuItem
                  onClick={() => dispatch(filtersubcategorys("rerries"))}
                >
                ...
                <MenuItem
                  onClick={() => dispatch(filtersubcategorys("drupes"))}
                >
                  <p className=" text-sm font-normal  text-left pl-6 text-[#8f8c8c] w-[50%]">
                    Drupes
                  </p>{" "}
                ...
                <MenuItem
                  onClick={() =>
                    dispatch(filtersubcategorys("tropical fruits"))
                  }
                >
                  <p className=" text-sm font-normal  text-left pl-6 text-[#8f8c8c] w-[50%]">
                    {" "}
              ...
              >
                <MenuItem
                  onClick={() => dispatch(filtersubcategorys("butter"))}
                >
                  <p className=" text-sm font-normal  text-left pl-6 text-[#8f8c8c] w-[50%]">
                    Butter
                  </p>{" "}
                ...
                <MenuItem
                  onClick={() => dispatch(filtersubcategorys("yougurt"))}
                >
                  <p className=" text-sm font-normal  text-left pl-6 text-[#8f8c8c] w-[50%]">
                    Yougurt
                  </p>{" "}
              ...
              >
                ...
                <MenuItem
                  onClick={() => dispatch(filtersubcategorys("syrups"))}
                >
                  <p className=" text-sm font-normal  text-left pl-6 text-[#8f8c8c] w-[50%]">
                    Syrup
                  </p>
              ...
              >
                ...
                <MenuItem
                  onClick={() => dispatch(filtersubcategorys("coffee"))}
                >
                  <p className=" text-sm font-normal  text-left pl-6 text-[#8f8c8c] w-[50%]">
                    coffee
                  </p>
              ...
              >
                ...
                <MenuItem
                  onClick={() => dispatch(filtersubcategorys("juices"))}
                >
                  <p className=" text-sm font-normal  text-left pl-6 text-[#8f8c8c] w-[50%]">
                    Juice
                  </p>
              ...
              >
                ...
                <MenuItem
                  onClick={() => dispatch(filtersubcategorys("Noodles"))}
                >
                  <p className=" text-sm font-normal  text-left pl-6 text-[#8f8c8c] w-[50%]">
                    Noodles
                  </p>
                ...
                <MenuItem
                  onClick={() => dispatch(filtersubcategorys("Sauces"))}
                >
                  <p className=" text-sm font-normal  text-left pl-6 text-[#8f8c8c] w-[50%]">
                    Sauces
                  </p>
